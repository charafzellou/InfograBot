...
void Robot::corp()
{
    //partie haute
        glPushMatrix();
            ...
            glRotatef(-10,1,0,0);
            glPushMatrix();
                gluCylinder(gluNewQuadric(), 0.9, 1.0, 1.0, 54, 54);
            glPopMatrix();
        glPopMatrix();
        glPushMatrix();
            glTranslatef(0.0, -0.6, -2.0);
            glRotatef(-20,1,0,0);
            gluCylinder(gluNewQuadric(), 0.8, 0.9, 1.0, 54, 54);
        glPopMatrix();
        glPushMatrix();
            glTranslatef(0.0, -1.1, -2.8);
            glRotatef(-30,1,0,0);
            gluCylinder(gluNewQuadric(), 0.7, 0.8, 1.0, 54, 54);
        glPopMatrix();
        glPushMatrix();
            glTranslatef(0.0, -1.7, -3.5);
            glRotatef(-40,1,0,0);
            gluCylinder(gluNewQuadric(), 0.6, 0.7, 1.0, 54, 54);
        glPopMatrix();
        glPushMatrix();
            glTranslatef(0.0, -2.3, -4.0);
            glRotatef(-50,1,0,0);
            gluCylinder(gluNewQuadric(), 0.5, 0.6, 1.0, 54, 54);
        glPopMatrix();
        glPushMatrix();
            glTranslatef(0.0, -3.2, -4.5);
            glRotatef(-60,1,0,0);
            //glTranslatef(0.0, 0.0, -0.2);
            gluCylinder(gluNewQuadric(), 0.1, 0.5, 1.0, 54, 54);
        glPopMatrix();

        gluCylinder(gluNewQuadric(), 1.0, 1.0, 1.0, 54, 54);//cylindre central
        //partie basse
        glPushMatrix();
            glTranslatef(0.0, 0.0, 1.0);
            glRotatef(10,1,0,0);
            glPushMatrix();
                gluCylinder(gluNewQuadric(), 1.0, 0.9, 1.0, 54, 54);
            glPopMatrix();
        glPopMatrix();
        glPushMatrix();
            glTranslatef(0.0, -0.2, 2.0);
            glRotatef(20,1,0,0);
            gluCylinder(gluNewQuadric(), 0.9, 0.8, 1.0, 54, 54);
        glPopMatrix();
        glPushMatrix();
            glTranslatef(0.0, -0.6, 3.0);
            glRotatef(30,1,0,0);
            gluCylinder(gluNewQuadric(), 0.8, 0.7, 1.0, 54, 54);
        glPopMatrix();
        glPushMatrix();
            glTranslatef(0.0, -1.1, 3.8);
            glRotatef(40,1,0,0);
            gluCylinder(gluNewQuadric(), 0.7, 0.6, 1.0, 54, 54);
        glPopMatrix();
        glPushMatrix();
            glTranslatef(0.0, -1.7, 4.5);
            glRotatef(50,1,0,0);
            //glTranslatef(0.0, 0.0, -0.2);
            gluCylinder(gluNewQuadric(), 0.6, 0.5, 1.0, 54, 54);
        glPopMatrix();
        glPushMatrix();
            glTranslatef(0.0, -2.3, 5.0);
            glRotatef(60,1,0,0);
            //glTranslatef(0.0, 0.0, -0.2);
            gluCylinder(gluNewQuadric(), 0.5, 0.1, 1.0, 54, 54);
        glPopMatrix();
}
void Robot::brasGauche()
{
    glPushMatrix();
        ...
        glPushMatrix();
            ...
            glPushMatrix();
                glRotatef(90,0,1,0);
                gluCylinder(gluNewQuadric(), 0.5, 0.5, 2.0, 54, 54);
                glTranslatef(-1.0, 0.0, 0.0);
            glPopMatrix();
            glTranslatef(-1.0, 0.0, 0.0);
        glPopMatrix();
